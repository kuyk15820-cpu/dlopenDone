...
#endif     
     NSString *resourceName = [NSString stringWithUTF8String:AY_OBFUSCATE("F1X3R")];
     NSString *resourceExt = [NSString stringWithUTF8String:AY_OBFUSCATE("bundle")];
     
     NSURL *url = [bundle URLForResource:resourceName withExtension:resourceExt];
